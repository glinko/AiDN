...
- Modify: `docs/archive/plans/2026-06-19-m3-wallet-pricing-and-usage-metering.md`
...
```bash
git add tests/test_wallet.py tests/test_api.py ROADMAP.md docs/archive/plans/2026-06-19-m3-wallet-pricing-and-usage-metering.md

...
In `docs/archive/specifications/2026-07-13-rfc-implementation-alignment-audit.md`, update the `Session contract binding` row to:
...
```powershell
rg -n "session_contract_object_id|immutable `session_contract` Registry Object|RFC-0044" ROADMAP.md docs/archive/specifications/2026-07-13-rfc-implementation-alignment-audit.md
```
...
```powershell
git add ROADMAP.md docs/archive/specifications/2026-07-13-rfc-implementation-alignment-audit.md

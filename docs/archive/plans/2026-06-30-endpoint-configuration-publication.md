...
**Files:**
- Modify: `ROADMAP.md`
- Modify: `docs/archive/specifications/2026-06-29-endpoint-first-transition-design.md`
...
Run: open `ROADMAP.md` and `docs/archive/specifications/2026-06-29-endpoint-first-transition-design.md`
...
```bash
git add ROADMAP.md docs/archive/specifications/2026-06-29-endpoint-first-transition-design.md
...
Plan complete and saved to `docs/archive/plans/2026-06-30-endpoint-configuration-publication.md`. Two execution options:

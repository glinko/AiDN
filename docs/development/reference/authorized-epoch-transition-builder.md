...
is recorded in
`docs/evidence/epoch-transition-input-query-rollout-acceptance-2026-08-13.md`.
...
[`epoch-schedule-commit-gate-rollout-acceptance-2026-08-13.md`](../../evidence/epoch-schedule-commit-gate-rollout-acceptance-2026-08-13.md).

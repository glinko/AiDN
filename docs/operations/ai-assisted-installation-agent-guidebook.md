...
Проверка полноты и проект расширения до публикации описаны в
[дополнении к ранбуку](endpoint-publication-agent-runbook-review.md).
Оно различает существующие возможности и требуемые доработки; неподдержанные
поля и переходы нельзя считать реализованными на основании этого документа.

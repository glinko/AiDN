...
- the broader `UX-0001` module vocabulary around `Providers`, `Bundles`, `Endpoints`, `Remote Endpoints`, `Wallet`, `Validation`, `Marketplace`, `Metrics`, `MCP`, and `Settings`;
...
It should also make room for `UX-0001` operator flows that do not fit into a single table:
- wallet ownership bootstrap;
- endpoint creation and publication;
- remote endpoint attach;
- explicit validation requests;
- MCP-driven operator automation.
...
- Operator journey: [../../product/UX-0001-hypervisor-operator-journey.md](../../product/UX-0001-hypervisor-operator-journey.md)

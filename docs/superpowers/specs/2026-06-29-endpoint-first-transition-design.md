...
2. endpoint advertisement generation from manifest state
3. capability attachment through a formal capability SDK layer
4. task submission and routing by `endpoint_id`
5. dashboard migration from bundle-centric views to endpoint-centric views

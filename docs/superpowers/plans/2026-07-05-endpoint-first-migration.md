...
- `docs/superpowers/specs/2026-07-05-endpoint-first-migration-design.md`
...
Plan complete and saved to `docs/superpowers/plans/2026-07-05-endpoint-first-migration.md`. Two execution options:

...
- `docs/superpowers/specs/2026-07-04-guided-dashboard-onboarding-design.md`
- `ROADMAP.md`
...
**Files:**
- Modify: `ROADMAP.md`
- Modify: `docs/superpowers/specs/2026-07-04-guided-dashboard-onboarding-design.md` (only if implementation drift requires a factual correction)
...
```bash
git add ROADMAP.md docs/superpowers/specs/2026-07-04-guided-dashboard-onboarding-design.md

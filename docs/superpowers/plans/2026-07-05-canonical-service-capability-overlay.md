...
- `docs/superpowers/specs/2026-07-05-canonical-service-capability-overlay-design.md`
...
Plan complete and saved to `docs/superpowers/plans/2026-07-05-canonical-service-capability-overlay.md`. Two execution options:

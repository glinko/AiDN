...
```bash
git add src/aidn_hypervisor/validation/service.py src/aidn_hypervisor/api.py tests/validation/test_service.py tests/test_api.py docs/superpowers/plans/2026-07-02-m5-validation-epochs-and-summary.md

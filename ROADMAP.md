...
1. Extend the first opt-in real `llama.cpp` Health/model/completion/Usage smoke profile into RFC-0054 Runtime Adapter conformance and fault-injection scenarios; then apply the same suite to Ollama, vLLM-compatible and Proxy profiles.

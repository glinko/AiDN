...
- extend the new declared `usage_contract` billing-unit gate from explicit legacy Plugin declarations to every approved RFC-0054 Runtime Usage Profile, and bridge the new `audio_input_seconds` operator-metering unit into canonical `q_atoms` Settlement;

...
1. Add a real Local IPC listener behind the existing Dispatcher ingress boundary, starting with the Windows Named Pipe profile; then broaden conformance fault-injection scenarios.

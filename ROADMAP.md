...
4. Harden `MVP-0001` negative paths: missing Final Usage, conflicting Usage chain, wrong Endpoint/Session binding, duplicate finalize, timeout refund and forced fixed-price payment

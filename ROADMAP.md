...
1. Complete RFC-0054 transport and execution events on the durable core: Local IPC adapter, Ready/Health/capacity/result/cancel/stream/artifact/checkpoint/recovery/drain, then conformance fault injection.

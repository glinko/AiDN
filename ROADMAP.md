...
4. Verify `MVP-0001` persistence/recovery across restart: canonical funding, Runtime evidence, settlement proposals, forced settlement records and closed Session snapshots survive restore without duplicate economic effects

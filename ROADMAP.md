...
4. Connect the `MVP-0001` paid path to the real Runtime execution adapter flow instead of seeded test evidence, preserving the same Request/Result/Final Usage/Settlement invariants

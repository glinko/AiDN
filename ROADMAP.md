...
5. Use the independent-operator onboarding kit for the preceding Registry and finality evidence: [guide](./docs/development/independent-operator-onboarding-and-acceptance.md), secret-free workspace generator, read-only acceptance runner, and reviewed systemd template. Its reports intentionally do not establish independent ownership by themselves.

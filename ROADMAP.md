...
3. Add production package acquisition from signed sources to the verified local Package Store, then project signed Release metadata into the Registry `plugin` namespace.

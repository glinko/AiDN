...
4. Add an operator-facing one-click MVP paid smoke path that opens a fixed-price Session, submits the first Request, displays Result/Final Usage/Settlement readiness, and finalizes or force-finalizes from the dashboard/API

...
export const DEMO_ARTIFACT_CONFIGS: ReadonlyArray<CubeConfig> = Object.freeze([
  createArtifactConfig({ id: 'artifact-02', cluster: 'legacy', position: [-2.75, 0.58, 1.05], size: 0.36, color: '#b9aceb', attenuationColor: '#7e72b4', baseYaw: -0.52, basePitch: 0.10, baseRoll: -0.04, driftAmplitude: 0.035, driftFrequency: 0.22, pitchSpeed: 0.024, yawSpeed: 0.036, rollSpeed: -0.018 }),
  createArtifactConfig({ id: 'artifact-03', cluster: 'legacy', position: [-1.55, 0.62, 0.82], size: 0.42, color: '#efc2ad', attenuationColor: '#b27d70', baseYaw: 0.18, basePitch: -0.06, baseRoll: 0.08, driftAmplitude: 0.040, driftFrequency: 0.27, pitchSpeed: -0.021, yawSpeed: -0.048, rollSpeed: 0.016 }),
  createArtifactConfig({ id: 'artifact-04', cluster: 'legacy', position: [-2.25, 0.60, 0.18], size: 0.33, color: '#a5d9df', attenuationColor: '#6c9da8', baseYaw: -0.30, basePitch: 0.05, baseRoll: 0.10, driftAmplitude: 0.030, driftFrequency: 0.24, pitchSpeed: 0.030, yawSpeed: 0.041, rollSpeed: 0.021 }),
  createArtifactConfig({ id: 'artifact-05', cluster: 'legacy', position: [-1.15, 0.56, 0.45], size: 0.46, color: '#c4e7d4', attenuationColor: '#78a993', baseYaw: 0.42, basePitch: 0.02, baseRoll: -0.12, driftAmplitude: 0.046, driftFrequency: 0.19, pitchSpeed: -0.027, yawSpeed: 0.032, rollSpeed: -0.019 }),
  createArtifactConfig({ id: 'artifact-06', cluster: 'legacy', position: [-2.65, 0.58, -0.55], size: 0.38, color: '#e5b8d2', attenuationColor: '#a9799b', baseYaw: -0.20, basePitch: 0.11, baseRoll: 0.06, driftAmplitude: 0.034, driftFrequency: 0.31, pitchSpeed: 0.019, yawSpeed: -0.040, rollSpeed: 0.025 }),
  createArtifactConfig({ id: 'artifact-07', cluster: 'legacy', position: [-1.42, 0.60, -1.08], size: 0.30, color: '#e7d38f', attenuationColor: '#aa9258', baseYaw: 0.58, basePitch: -0.08, baseRoll: -0.10, driftAmplitude: 0.028, driftFrequency: 0.26, pitchSpeed: -0.024, yawSpeed: 0.052, rollSpeed: 0.018 }),
  createArtifactConfig({ id: 'artifact-08', cluster: 'active', position: [-0.28, 0.56, 1.18], size: 0.44, color: '#aac6ee', attenuationColor: '#718cb8', baseYaw: -0.14, basePitch: 0.06, baseRoll: 0.12, driftAmplitude: 0.038, driftFrequency: 0.23, pitchSpeed: 0.028, yawSpeed: -0.038, rollSpeed: -0.022 }),
  createArtifactConfig({ id: 'artifact-09', cluster: 'active', position: [0.78, 0.62, 0.82], size: 0.35, color: '#d4b5ef', attenuationColor: '#9179b0', baseYaw: 0.35, basePitch: -0.10, baseRoll: 0.04, driftAmplitude: 0.032, driftFrequency: 0.29, pitchSpeed: -0.022, yawSpeed: 0.046, rollSpeed: 0.017 }),
  createArtifactConfig({ id: 'artifact-10', cluster: 'active', position: [-0.55, 0.64, 0.15], size: 0.50, color: '#a3dbcf', attenuationColor: '#659d98', baseYaw: -0.42, basePitch: 0.04, baseRoll: -0.08, driftAmplitude: 0.043, driftFrequency: 0.21, pitchSpeed: 0.024, yawSpeed: -0.032, rollSpeed: 0.020 }),
  createArtifactConfig({ id: 'artifact-11', cluster: 'active', position: [1.55, 0.60, 0.15], size: 0.37, color: '#efc0ae', attenuationColor: '#b47f73', baseYaw: 0.22, basePitch: 0.09, baseRoll: 0.02, driftAmplitude: 0.031, driftFrequency: 0.34, pitchSpeed: -0.031, yawSpeed: 0.039, rollSpeed: -0.018 }),
  createArtifactConfig({ id: 'artifact-12', cluster: 'active', position: [-1.05, 0.62, -0.45], size: 0.31, color: '#c4b3ef', attenuationColor: '#8275b6', baseYaw: -0.60, basePitch: -0.04, baseRoll: 0.13, driftAmplitude: 0.027, driftFrequency: 0.25, pitchSpeed: 0.020, yawSpeed: -0.050, rollSpeed: 0.022 }),
  createArtifactConfig({ id: 'artifact-13', cluster: 'active', position: [0.10, 0.56, -0.62], size: 0.43, color: '#efd18e', attenuationColor: '#ae9153', baseYaw: 0.08, basePitch: 0.12, baseRoll: -0.06, driftAmplitude: 0.040, driftFrequency: 0.20, pitchSpeed: -0.026, yawSpeed: 0.034, rollSpeed: -0.021 }),
  createArtifactConfig({ id: 'artifact-14', cluster: 'new', position: [2.00, 0.58, 1.18], size: 0.35, color: '#a6d9e8', attenuationColor: '#6598aa', baseYaw: -0.28, basePitch: -0.07, baseRoll: 0.08, driftAmplitude: 0.034, driftFrequency: 0.30, pitchSpeed: 0.029, yawSpeed: -0.042, rollSpeed: 0.018 }),
  createArtifactConfig({ id: 'artifact-15', cluster: 'new', position: [1.35, 0.64, 0.72], size: 0.47, color: '#d2b5ef', attenuationColor: '#8975aa', baseYaw: 0.48, basePitch: 0.03, baseRoll: -0.11, driftAmplitude: 0.042, driftFrequency: 0.22, pitchSpeed: -0.020, yawSpeed: 0.045, rollSpeed: -0.023 }),
  createArtifactConfig({ id: 'artifact-16', cluster: 'new', position: [1.75, 0.60, -0.35], size: 0.32, color: '#ecb7aa', attenuationColor: '#aa7169', baseYaw: -0.52, basePitch: 0.08, baseRoll: 0.05, driftAmplitude: 0.029, driftFrequency: 0.27, pitchSpeed: 0.026, yawSpeed: -0.036, rollSpeed: 0.021 }),
  createArtifactConfig({ id: 'artifact-17', cluster: 'new', position: [2.15, 0.62, -1.05], size: 0.40, color: '#b5e3cd', attenuationColor: '#6f9e88', baseYaw: 0.30, basePitch: -0.12, baseRoll: -0.02, driftAmplitude: 0.036, driftFrequency: 0.24, pitchSpeed: -0.023, yawSpeed: 0.050, rollSpeed: -0.016 }),
  createArtifactConfig({ id: 'artifact-18', cluster: 'new', position: [-0.55, 0.56, -1.15], size: 0.44, color: '#b2c4ec', attenuationColor: '#7183b0', baseYaw: -0.04, basePitch: 0.06, baseRoll: 0.14, driftAmplitude: 0.039, driftFrequency: 0.18, pitchSpeed: 0.021, yawSpeed: -0.041, rollSpeed: 0.019 }),
  createArtifactConfig({ id: 'artifact-19', cluster: 'new', position: [0.52, 0.64, -1.02], size: 0.30, color: '#efd28f', attenuationColor: '#a99052', baseYaw: 0.62, basePitch: -0.02, baseRoll: -0.07, driftAmplitude: 0.026, driftFrequency: 0.32, pitchSpeed: -0.028, yawSpeed: 0.038, rollSpeed: 0.024 }),
  createArtifactConfig({ id: 'artifact-20', cluster: 'new', position: [1.08, 0.58, -0.88], size: 0.38, color: '#dfb5dc', attenuationColor: '#9c719b', baseYaw: -0.34, basePitch: 0.10, baseRoll: 0.09, driftAmplitude: 0.033, driftFrequency: 0.28, pitchSpeed: 0.025, yawSpeed: -0.047, rollSpeed: -0.020 }),
])

ROWS = (
 ...
 ("CHAT:WRITE","Actions","medium","aidn.operator.chat.reply aidn.operator.chat.progress aidn.ui.read aidn.ui.present aidn.ui.apply aidn.ui.conversation","agent_chat"),

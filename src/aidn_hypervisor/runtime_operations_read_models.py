...
def _runtime_record(service, runtime, readiness: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "lifecycle_state": getattr(runtime, "lifecycle_state", "STARTING"),
        "runtime_instance_state": getattr(runtime, "lifecycle_state", "STARTING"),
        "last_activity_at": getattr(runtime, "last_activity_at", None),
        "pinned_warm": bool(getattr(runtime, "pinned_warm", False)),

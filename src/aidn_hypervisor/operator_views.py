...
def build_operator_providers_payload(
    *,
    ...
    return build_provider_workspace_payload(
        service=service,
        ...
        items.append(
            {
                **install,
                ...
                "expected_sha256": raw_install.get("expected_sha256"),
                "expected_bytes": raw_install.get("expected_bytes"),
                "artifact_sha256": raw_install.get("artifact_sha256"),
...
def build_operator_endpoints_payload(
    *,
    ...
    for manifest in manifests:
        ...
        validation_payload = build_operator_endpoint_validation_payload(
            manifest=manifest,
            validation_service=validation_service,
            published_endpoint_configuration_hash=published_endpoint_configuration_hash,
        ...
        items.append(
            {
                ...
                "validation_summary": validation_payload["validation_summary"],
                "published_validation_summary": validation_payload[
                    "published_validation_summary"
                ],

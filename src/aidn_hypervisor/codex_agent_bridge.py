...
class CodexAgentBridge:
    ...
    def _run_turn(self, process: JsonLineRpcProcess, thread_id: str, operator_text: str, *, ui: dict | None = None) -> str:
        prompt = (
            ...
            "hash-bound plan; unresolved ask policies must be rendered as safe recommendations (private, free, "
            "required, deny, parallel) and become answers only after form submission. Do not treat a chat acknowledgement "
            "as a form confirmation. When the form intent is "

#!/usr/bin/env python3
"""Sign one unsigned EPOCH_SCHEDULE_COMMIT as one protocol authority."""
...
def main() -> int:
    ...
    signature = sign_epoch_schedule_commit_signature(
        envelope,
        policy=policy,
    ...
    artifact = {
        "artifact_version": "aidn.epoch-schedule-signature.v1",

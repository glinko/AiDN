#!/usr/bin/env python3
"""Create a creator-authorized TREASURY_MANIFEST_BIND consensus envelope."""
...
def main() -> int:
    ...
    if manifest.funding_mode != "CONSENSUS" or manifest.funding_operation_id is not None:
        raise ValueError("manifest bind requires a pre-finality CONSENSUS Treasury manifest")

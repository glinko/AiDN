#!/usr/bin/env python3
"""Prepare an unsigned, policy-bound EPOCH_RESULT_MANIFEST_COMMIT offline."""
...
from aidn_hypervisor.consensus.epoch_result_manifest import EpochResultManifest  # noqa: E402
...
def main() -> int:
    ...
    manifest = EpochResultManifest.model_validate(_object(args.manifest))

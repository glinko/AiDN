...
root="${AIDN_G5_REPLACEMENT_ROOT:-/home/user/aidn-g5-reprovision}"
repo="${AIDN_G5_REPLACEMENT_REPO:-/home/user/aidn/AiDN}"
source_home="${AIDN_G5_REPLACEMENT_SOURCE_HOME:-/home/user/aidn-g5-clean/node}"
comet_bin="${AIDN_G5_REPLACEMENT_COMET_BIN:-/home/user/aidn-g5-clean/cometbft}"
